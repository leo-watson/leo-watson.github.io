...
Gem::Specification.new do |s|
  ...
  s.add_runtime_dependency(%q<rb-fsevent>.freeze, [">= 0.9.3".freeze])
  s.add_runtime_dependency(%q<rb-inotify>.freeze, [">= 0.9".freeze])
  s.add_runtime_dependency(%q<rb-kqueue>.freeze, [">= 0.2".freeze])
